...
xFileNameCount = 0;
for xInterpGrid = 0:(MapXRange-1)	%(MapXRange-1)
   
   yFileNameCount = 0;
   for yInterpGrid = 0:(MapYRange-1)	%(MapXRange-1)
      ...
      [xiFine,yiFine] = meshgrid(0:MapDivisionMax:(MapXRange-MapDivisionMax ), 0:MapDivisionMax:(MapYRange-MapDivisionMax));
